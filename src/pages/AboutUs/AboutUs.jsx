    ...
    return (
        <div className="max-w-5xl mx-auto px-4 py-12">
            <Card className="bg-white">
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-semibold text-center text-gray-800 flex items-center justify-center gap-2 mb-4">
                        <FaStar className="text-yellow-500" /> Why Choose MarryNow?
                    </h2>
                    <ul className="list-disc ml-10 text-gray-700 space-y-2 text-left">
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-semibold text-center text-gray-800 flex items-center justify-center gap-2 mb-4">
                        <FaEnvelope className="text-red-500" /> Need Help?
                    </h2>
                    <p className="text-gray-700 text-center">
