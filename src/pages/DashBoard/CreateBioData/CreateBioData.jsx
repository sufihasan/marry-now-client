...
const CreateBioData = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md my-8">
            <h2 className="text-3xl font-bold mb-6 text-center dark:text-gray-200">Create Bio Data</h2>
