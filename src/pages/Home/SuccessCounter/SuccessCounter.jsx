...
const SuccessCounter = ({ totalBiodata, totalBoys, totalGirls }) => {
    ...
    return (
        <div className="w-11/12 mx-auto mt-10">
            ...
            <h1 className="text-3xl font-bold text-center mb-5">Some Info about MarryNow</h1>

            <div className='grid text-center grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 justify-center'>
                <div className='bg-base-200 rounded-xl border border-gray-200 py-10 ps-8 pr-20'>
                    ...
                    <p className='text-gray-500'>total biodata</p>
                </div>
                <div className='bg-base-200 rounded-xl border border-gray-200 py-10 ps-8 pr-20'>
                    ...
                    <p className='text-gray-500'>Total boys biodata</p>
                </div>
                <div className='bg-base-200 rounded-xl border border-gray-200 py-10 ps-8 pr-20'>
                    ...
                    <p className='text-gray-500'>Total girls biodata</p>
                </div>
                <div className='bg-base-200 rounded-xl border border-gray-200 py-10 ps-8 pr-20'>
                    ...
                    <p className='text-gray-500'>Total marriages complete</p>
                </div>
